...
import com.corn.trade.web.api.CurrencyAPI;
...
import com.corn.trade.web.mapper.CurrencyRateMapper;
import com.corn.trade.web.repository.CurrencyRateRepository;
...
public class CurrencyRateService {
	...
	public Double convertToUSD(long currencyId, Double amount, LocalDate dateTime) throws JsonProcessingException {
		...
		return Util.round(amount / currencyRateDTO.rate(), 2);
	}
